...
<form action="<?php echo base_url('gradingsys/update') ?>" method ="post" class = "form-horizontal">
	...
	<div class = "form-group">
		...
		<div class = "col-md-10">
			<input type="number" min="0" max="100" value = "<?php echo $students->Math;?>" name="Math">
		</div>
	</div>
	<div class = "form-group">
		<label for="Science" class="col-md-2 text-right">Science</label>
		<div class = "col-md-10">
			<input type="number" min="0" max="100" value = "<?php echo $students->Science?>" name="Science">
		</div>
	</div>
	<div class = "form-group">
		<label for="English" class="col-md-2 text-right">English</label>
		<div class = "col-md-10">
			<input type="number" min="0" max="100" value = "<?php echo $students->English;?>" name="English">
		</div>
	</div>
	<div class = "form-group">
		<label for="Filipino" class="col-md-2 text-right">Filipino</label>
		<div class = "col-md-10">
			<input type="number" min="0" max="100" value = "<?php echo $students->Filipino;?>" name="Filipino">
		</div>
	</div>
	<div class = "form-group">
		<label for="Mapeh" class="col-md-2 text-right">MAPEH</label>
		<div class = "col-md-10">
			<input type="number" min="0" max="100" value = "<?php echo $students->Mapeh;?>"name="Mapeh">
		</div>
	</div>	
	<div class = "form-group">
